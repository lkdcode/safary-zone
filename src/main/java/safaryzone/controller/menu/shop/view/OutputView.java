package safaryzone.controller.menu.shop.view;
...
public class OutputView {
    ...
    private final String FIRST_BALL = "1️⃣ 일반 몬스터 볼 - 1200머니 👉 [포획 확률 : 30%]";
    private final String SECOND_BALL = "2️⃣ 하이퍼 몬스터 볼 - 5000머니 👉 [포획 확률 : 50%]";
    private final String THIRD_BALL = "3️⃣ 마스터 몬스터 볼 - 7500머니 👉 [포획 확률 : 75%]";
    ...
    public void showMonsterBallMenu() {
        ...
        MakeCommon.dottedPrint(message, SHORT_MILLIS);
    }
    ...
    public void failBuyMonsterBall() {
        MakeCommon.dottedPrint(FAIL_BUY_MONSTER_BALL, MILLIS);
    }

    public void failBuyBerry() {
        MakeCommon.dottedPrint(FAIL_BUY_BERRY, MILLIS);
    }
    ...
    public void inputQuantity() {
        MakeCommon.dottedPrint(INPUT_QUANTITY, MILLIS);
    }
