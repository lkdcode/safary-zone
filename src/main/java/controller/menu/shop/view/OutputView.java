...
public class OutputView {
    ...
    private final String FIRST_BERRY = "1. 🍓 라즈 베리 - 500머니 👉 [일정 확률로 상,하로 열매를 뿌립니다.]";
    private final String SECOND_BERRY = "2. 🍇 블루 베리 - 2000머니 👉 [일정 확률로 좌,우로 열매를 뿌립니다.]";
    private final String THIRD_BERRY = "3. ♣️ 블랙 베리 - 3500머니 👉 [일정 확률로 상,하,좌,우로 열매를 뿌립니다.]";
